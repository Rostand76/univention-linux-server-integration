...
MASTER_IP=192.168.100.23 # LDAP Server IP
ldap_master=third.cm # my DNS to the ldap 
ldap_base="dc=third,dc=cm"
...
yum install -y sssd sssd-tools redhat-lsb-core sssd-ldap openldap-clients authconfig  oddjob-mkhomedir pam_krb5 samba4-common krb5-workstation
...
THIRD.CM = {
  kdc = 192.168.100.23
  kdc = ad.third.cm
  admin_server = 192.168.100.23
  admin_server = ad.third.cm
   kpasswd_server = 192.168.100.23 ad.third.cm
}
[domain_realm]
 third.cm = THIRD.CM
 .third.cm = THIRD.CM
